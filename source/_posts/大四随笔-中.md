...
通过阅读掘金大佬的文章: [dispatch 和 commit 来调用 mutations 的区别](https://segmentfault.com/a/1190000015254514), 了解到——`vuex` 规定必须由 `mutation` 改变 `state`, 而:
...
- [移动端知识点集锦系列之——H5 的载体类型](https://blog.yyge.top/blog/2019/12/11/%E7%A7%BB%E5%8A%A8%E7%AB%AF%E7%9F%A5%E8%AF%86%E7%82%B9%E9%9B%86%E9%94%A6%E7%B3%BB%E5%88%97%E4%B9%8B%E2%80%94%E2%80%94H5%E7%9A%84%E8%BD%BD%E4%BD%93%E7%B1%BB%E5%9E%8B/)
...
今天将其归纳到博客: [git 常用命令集锦](https://blog.yyge.top/blog/2019/03/12/git%E5%B8%B8%E7%94%A8%E5%91%BD%E4%BB%A4%E9%9B%86%E5%90%88/) 中, 便于后续的参考.
...
- \[git]: Fatal: out of memory, malloc failed (tried to allocate 1514190 bytes)
  ...
  - **解决方式**: `git config http.postbuffer 8888888`
...
- git 常用命令集合
  - 使用 `git tag newTagName oldTagName`、`git tag -d oldTagName` 来重命名旧的标签, 但是需要注意, 这种方式不能更改已经推送到 origin 仓库的 tag

> 2. ts-utility-plugins

- 新增 [zip](https://github.com/ddzy/ts-utility-plugins/commit/77082a249612040bdee6ca5d12c3e13b763eef8e) 工具方法, 旨在模拟 [lodash.zip](https://lodash.com/docs/#zip) 方法, 提取二维数组每项的同位置的值
- 发布 [v1.1](https://github.com/ddzy/ts-utility-plugins/tree/v1.1) 版本
...
- \[新增]: 国外优质博客社区: [Medium](https://medium.com/)
- \[更新日志]: [CHANGELOG.md](https://github.com/ddzy/fe-necessary-book/blob/master/CHANGELOG.md#-2019-12-23)
